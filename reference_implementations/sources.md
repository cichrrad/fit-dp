...
[X] [`hipr4` should be improved version of hi_pr above (linked on DIMACS 13th challenge))](https://coral.ise.lehigh.edu/flow-challenge-2-0/max-flow-reference-solvers/)
